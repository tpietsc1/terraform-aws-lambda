...
- inline configuration for DynamodDb, EventBridge (CloudWatch Events), Kinesis, SNS or SQS trigger including required permissions
...
**with EventBridge (CloudWatch Events) rules**
